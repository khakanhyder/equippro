      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 bg-background">
        <Card className="w-full max-w-md border-0 shadow-none">
          ...
          <CardContent className="space-y-4">
            <Button variant="outline" className="w-full" data-testid="button-login-google">
            ...
            <Button variant="outline" className="w-full" data-testid="button-login-github">
            ...
            <div className="space-y-3">
              <div className="space-y-2">
                ...
                <Input id="email" type="email" placeholder="name@example.com" data-testid="input-login-email" />
              </div>
              
              <div className="space-y-2">
                <Label htmlFor="password">Password</Label>
                <Input id="password" type="password" data-testid="input-login-password" />
              </div>
            </div>

            <Button className="w-full" data-testid="button-submit-login">
